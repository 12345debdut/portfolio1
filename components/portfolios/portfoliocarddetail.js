      ...
      <div>
        <Modal isOpen={isOpen} toggle={toggle}>
          ...
          <ModalBody>
            ...
            <p><b>Start Date:</b>{' '}{moment(portfolio.startdate).format('DD/MM/YYYY')}</p>
            <p><b>End Date:</b>{' '}{portfolio.enddate ? moment(portfolio.enddate).format('DD/MM/YYYY'):"still working here"}</p>
          </ModalBody>
          <ModalFooter>
